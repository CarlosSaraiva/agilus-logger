...
exports["find"] = {
    ...
    'options.mark': function(test) {
        ...
        ], "should match files and directories.");
        test.deepEqual(globule.find("**d*/**/"), [
            "deep/",
            "deep/deeper/",
            "deep/deeper/deepest/"
        ], "trailing / in pattern should match directories only, matches end in /.");
        test.deepEqual(globule.find("**d*/**", { mark: true }), [
            ...
            "deep/deeper/deepest/",
            "deep/deeper/deepest/deepest.txt"
        ], "the minimatch \"mark\" option ensures directories end in /.");
        test.deepEqual(globule.find("**d*/**/", { mark: true }), [
            "deep/",
            "deep/deeper/",
            "deep/deeper/deepest/"
        ], "the minimatch \"mark\" option should not remove trailing / from matched paths.");
        test.done();
    },
