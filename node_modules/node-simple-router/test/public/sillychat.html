...
<div class="Page Header">
    <h1 style="color: #aa0000;">Silly Chat Server <small>Node Simple Router Websocket Demo</small>
    </h1>
</div>
    ...
    <div class="inputarea row">
        <div class="col-md-9">
            ...
            <div class="pull-right">
                <input id="txt-msg" type="text" value="" style="height: 2em; width: 45em;"/>
            </div>
        </div>
        <div class="col-md-3">
        </div>
    ...
    <div class="inputarea row">
        <form id="form-uploader" class="navbar-form">
            <div class="form-group">
                <input class="form-control" type="file" id="file-uploader">
            </div>
...
<script type="text/javascript" src="/js/chat_app.js">
