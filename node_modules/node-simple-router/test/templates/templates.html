<div class="row" style="margin-top: 3em;">
    <div class="col-xs-5" style="background: #ededed; border: solid 1px; border-radius: 7px; margin: 0.5em; padding: 0.5em;">
        <h3 style="text-align: center;">Template Settings</h3>
        <form class="form" method="post">
            <label for="txt-context">Context Object</label><br>
            <textarea rows="7" style="max-width: 100%; min-width: 100%; position: relative;" id="txt-context" name="txt_context">
{name: "Sandy",
hasHobbies: true,
...
bg: '#cceaff', pad: 1.5, radius: 10}
            ...
            <textarea rows="8" style="max-width: 100%; min-width: 100%; position: relative;" id="txt-template" name="txt_template">
<div style="background: {{bg}}; padding: {{pad}}em; border-radius: {{radius}}px;">
  ...
  {{/hasHobbies}}
    ...
    <div class="col-xs-6" style="border: solid 1px; border-radius: 7px; margin: 0.5em; padding: 0.5em;">
