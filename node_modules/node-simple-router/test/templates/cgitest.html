<div class="page-header">
    <h1><span class="nsr">NSR</span> connecting to CGI examples
    </h1>
</div>
...
<h3>Other Scripts</h3>
<p>
    <a href="/cgi-bin/printenv.pl">Print Environment Variables (Perl script)</a>
</p>
<p>
    <a href="/cgi-bin/envvars.py">Print Environment Variables (Python script)</a>
</p>