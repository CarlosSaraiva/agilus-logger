<div>
    ...
    <h3>
        <a name="install" class="anchor" href="#install">
    ...
    <h3>
        <a name="doit" class="anchor" href="#doit">
            <span class="octicon octicon-link"></span></a>
    ...
    <div class="list-group">
        ...
        <div class="list-group-item">
            ...
            <p class="list-group-item-text">
                <code class="bg js">var http = require('http');</code>
            </p>
        </div>
        <div class="list-group-item">
            <h4 class="list-group-item-heading">Import NSR</h4>
            <p class="list-group-item-text">
                <code class="bg js">var Router = require('node-simple-router');</code>
            </p>
        </div>
        <div class="list-group-item">
            <h4 class="list-group-item-heading">Instantiate the router</h4>
            <p class="list-group-item-text">
                <code class="bg js">var router = Router(); // may also be router = new Router();</code>
            </p>
        </div>
        <div class="list-group-item">
            <h4 class="list-group-item-heading">Add some routes</h4>
            <p class="list-group-item-text">
                <code class="bg js">router.get("/hello", function(request, response) {response.end("Hello, World!"};});</code>
            </p>
        </div>
        <div class="list-group-item">
            <h4 class="list-group-item-heading">Create an http server using router as the handler</h4>
            <p class="list-group-item-text">
                <code class="bg js">var server = http.createServer(router);</code>
            </p>
        </div>
        <div class="list-group-item">
            <h4 class="list-group-item-heading">Finally, make it listen on your chosen port and you're in business</h4>
            <p class="list-group-item-text">
                <code class="bg js">server.listen(1234);</code>
            </p>
        </div>
    </div>
