...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <p>
            ...
            have some insight on a couple of key aspects, fundamentally what could be called the <em>
                "request wrapping
                mechanism"
            </em>.
        </p>
        <p>
            ...
            </code> what <span class="nsr">NSR</span>
        ...
        <p>
            ...
            the request method, for example: <code class="js">
                router.any("/threefold", function(request, response)
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <p>
            <pre><code class="js">var router = new Router({static_route: __dirname + "/static"});</code></pre></p>
...
<li class="list-group-item">
    ...
    adds to the <em>request</em> object the properties: <em>
        fileName, fileLen, fileData and
        fileType
    </em>, which client code (your server) can handle as shown in the following usage example.
...
<li class="list-group-item">
    <h4>
        <dfn>any</dfn>
    </h4>&nbsp;&nbsp;&nbsp;To be used when the request method is not known in advance. Sort of "catch all"
...
<li class="list-group-item">
    <h4>
        <dfn>proxy_pass</dfn>
    </h4>&nbsp;&nbsp;&nbsp;To deliver to the client the contents of an url from another server
...
<li class="list-group-item">
    <div class="list-group-item-heading">
        <p><h4>
            ...
            </h4>&nbsp;&nbsp;&nbsp;To pass the client the results of an external CGI program.
        </p>
    </div>
    <div class="list-group-item-text">
        <p>
...
<li class="list-group-item">
    <div class="list-group-item-heading">
        ...
        <p>To pass the client the results of an external program running under the <a target="_blank" href="http://en.wikipedia.org/wiki/SCGI">SCGI</a> protocol.
        </p>
    </div>
    <div class="list-group-item-text">
        <p>Same considerations as those pertaining to CGI, with the added benefit of not having to spawn a new process each time.</p>
        <p>Why SCGI and not <dfn title="Fast CGI">FCGI</dfn>? Well, SCGI protocol was far easier to implement, and I really couldn't find significant performance differences between the two. FCGI may be implenented in future versions.
        </p>
        <p>
            <pre>
  <em>Usage:</em><br/>
...
<li class="list-group-item">
    <div class="list-group-item-heading">
        ...
        <p>To provide rudimentary template handling without compromising the goal of keeping <span class="nsr">NSR</span> lean and simple.
        </p>
    </div>
    <div class="list-group-item-text">
        <p>
  ...
  router.get("/greet_user/:user_id", function(request, response) {
    get_user_by_id(request.params.user_id, function (user) {
      ...
      response.end(compiled_str);
        ...
        <p>
            New in version 0.8.8: <code>render_template_file(fileName, context, callback, keep_tokens)</code> was added<br/>
...
<li class="list-group-item">
    <div class="list-group-item-heading">
        ...
        <p>This section deals with session handling utilities built in with <span class="nsr">NSR</span>.
        </p>
    </div>
    <div class="list-group-item-text">
        <p>
            ...
            <strong>
                <em>nsr_session</em>
            </strong> is a javascript object that holds the session keys and values
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <p>
            ...
            <a target="_blank" href="https://github.com/sandy98/node-simple-router/wiki/Utils">
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <p>
            ...
            but also the <strong>
                <em>ws</em>
            </strong> protocol (WebSockets) is implemented.
            <br/>
            See all the juicy details at <a target="_blank" href="https://github.com/sandy98/node-simple-router/wiki/WebSocket">
                WebSocket section of
                NSR wiki
            </a> or see it in action <a href="http://node-simple-router.herokuapp.com/sillychat.html">at the demo site.</a>
        </p>
    </div>
</div>
