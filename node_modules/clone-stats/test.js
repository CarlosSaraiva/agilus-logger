...
function compare(t, stat) {
    ...
    [
        "isDirectory", "isFile", "isBlockDevice", "isCharacterDevice", "isSymbolicLink", "isFIFO", "isSocket"
    ].forEach(function(method) {
        t.equal(
            stat[method].call(stat), copy[method].call(copy), "equal value for stat." + method + "()"
        );
    });
}